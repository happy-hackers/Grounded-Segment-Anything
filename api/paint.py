...
if __name__ == "__main__":
    ...
    # parser.add_argument("--texture", type=str, required=True, help="path to texture file")
    ...
    #     "/home/jupyter/ControlNet/data/images/03.jpg"
    # )
    # init_image = init_image.resize((600, 800))

    # mask_image = load_image(
    #     "/home/jupyter/ControlNet/data/masks/03-mask.png"
    # )
    # mask_image = mask_image.resize((600, 800))


    example_pil, example = load_image("/home/jupyter/ControlNet/data/texture/Elegance-Dark-Grey-pd.jpeg")

    image_pil = image_pil.resize((600,800))
    mask_pil = mask_pil.resize((600,800))
    example_pil = example_pil.resize((600,800))
    ...
    image = pipe(image=image_pil, mask_image=mask_pil, example_image=example_pil).images[0]
